...
<head>
    ...
    <link rel="stylesheet" href="/css/bg/amazeui.min.css" />
    <link rel="stylesheet" href="/css/bg/fullcalendar.min.css" />
    <link rel="stylesheet" href="/css/bg/fullcalendar.print.css" media='print' />
    <link rel="stylesheet" href="/css/bg/app.css">
...
<body data-type="widgets">
    ...
    <div class="am-g tpl-g">
        ...
        <header>
            ...
            <div class="am-fl tpl-header-logo">
                <a href="javascript:;"><img src="/img/bg/logo.png" alt=""></a>
            </div>
            <!-- 右侧内容 -->
        ...
        <div class="left-sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-nav-link">
                    <a href="/bg/tables.html">
                        <i class="am-icon-table sidebar-nav-link-logo"></i> 表格
                    </a>
                </li>
                <li class="sidebar-nav-link">
                    <a href="/bg/calendar.html">
    ...
    <script src="/js/bg/moment.js"></script>
    <script src="http://cdn.bootcss.com/amazeui/2.7.2/js/amazeui.min.js"></script>
    <script src="/js/bg/fullcalendar.min.js"></script>
