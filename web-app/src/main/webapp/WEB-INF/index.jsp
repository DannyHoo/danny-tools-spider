					...
					<div class=nav_box id=nav_box>
						<ul>
							<li>
								...
								<li>
									<a href='javascript:;' target=_blank clickid=guanwang_navigation_productcenter>Danny工具箱</a>
									<li>
										<a href='javascript:;' target=_blank clickid=guanwang_navigation_customer>交流互动</a>
										<li>
											<a href='javascript:;' target=_blank clickid=guanwang_navigation_yangtai>关于</a>
